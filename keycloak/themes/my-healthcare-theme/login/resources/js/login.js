...
(function() {
    ...
    function validateAndSecureAccess() {
        ...
        const isLegitimateClientRequest = clientId && codeChallenge;
        ...
        if (!isLegitimateClientRequest) {
            ...
            const socialProvidersContainer = document.getElementById('social-providers-container');
            ...
            const rememberForgotContainer = document.getElementById('remember-forgot-container');
            if (rememberForgotContainer && !forgotPasswordLink) {
                rememberForgotContainer.style.justifyContent = 'flex-start';
            }
            
            console.log('Access without client context detected - registration and password reset disabled');
        } else {
            console.log('Legitimate client request detected - full functionality enabled');
        }
    }
        ...
        loginForm.addEventListener('submit', function(e) {
            ...
            if (!isValid) {
                ...
                if (!existingError) {
                    ...
                    errorDiv.style.cssText = 'padding: 0.75rem; margin-bottom: 1rem; background: #fef2f2; border: 1px solid #fecaca; color: #991b1b; border-radius: 0.5rem; font-size: 0.875rem;';
