...
const API_BASE_URL =
  window.DoctauraConfig?.apiBaseUrl ||
  "https://your-dotnet-api.onrender.com/api/public";
...
async function loadSpecialties() {
  ...
  try {
    ...
    console.error(
      "Error loading specialties from API, using mock data:",
      error
    );
...
async function loadGovernorates() {
  ...
  try {
    ...
    console.error(
      "Error loading governorates from API, using mock data:",
      error
    );
